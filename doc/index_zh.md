...
1. 如果应用可以接受 Authing 标准 UI（见下图），则可以 [使用 Authing 风格的原生界面接入](./start_with_authing.md)：

![](./images/authing_login.png)

<br>

2. 如果应用需要自定义界面风格，则可以 [基于我们提供的主流 App 模板接入](./start_with_template.md)

3. [通过 WebView 接入](./start_with_webview.md)
