...
//        if (checkDebuggerConnected) return true;
    ...
    public static String getUniqueDeviceId(Context context, String prefix, boolean useCache) {
        ...
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    final String id = getString(context, KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(Context context, final String uniqueDeviceId) {
        ...
        final String cachedId = getString(context, KEY_UDID, null);
    ...
    public static String getString(Context context, @NonNull final String key, final String defaultValue) {
        SharedPreferences sp = context.getSharedPreferences("DeviceUtils", Context.MODE_PRIVATE);
        return sp.getString(key, defaultValue);
    }

    public static void put(Context context, @NonNull final String key, final String value) {
        SharedPreferences sp = context.getSharedPreferences("DeviceUtils", Context.MODE_PRIVATE);
